...
- **2025/12 左右起，火箭隊相關流程改為 Server Side，刷火箭隊刷星塵功能目前可能為永久不可用**
- **[Pokemod](#pokemod)屬於注入式軟體，使用可能會有風險**
- **此功能需使用 Pokemod Pro（付費贊助版本）**
- **官方註記：Team Blastoff（火箭隊）功能目前不可用，且可能無法恢復**
- 須注意[掛機時間](#軟體鎖)以免被軟鎖

目前建議視為不可用功能，請改用一般改定位玩法，不要依賴火箭隊刷星塵流程。
...
- **[PGTools](#pgtools)屬於注入式軟體，使用可能會有風險**
- **請先把帳號通過新手教學，再開啟使用[PGTools](#pgtools)，否則帳號可能會發生問題無法使用**
- 此為 [PGTools](#pgtools) 的 PaG 模式，屬贊助付費功能（目前不可用，且可能無法恢復）
- 須注意[掛機時間](#軟體鎖)以免被軟鎖

目前建議視為不可用功能，請改用一般改定位或其他非火箭隊流程。
...
- 建議可先依照自己需求設定，至左上角☰漢堡選單選擇功能模組，並依照需求啟用各項功能模組
- 設定完成後返回首頁，點擊"START"或是"啟動"即可開始使用

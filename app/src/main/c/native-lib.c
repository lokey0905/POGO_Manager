...
Java_app_lokey0905_location_Native_isMagiskPresentNative(JNIEnv *env,
 //                                                        jclass clazz) {
    // TODO: implement isMagiskPresentNative()
//}
//JNIEXPORT jboolean
//Java_app_lokey0905_location_Native_isMagiskPresentNativ(
//        JNIEnv *env,
        jobject this) {
    bool bRet = false;
    do {
